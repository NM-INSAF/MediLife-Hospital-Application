                ...
                <form action="doctor-search.php" method="get">
                    ...
                    <div class="col-md-4">
                        <div class="form-group position-relative">
                            <input type="text" class="form-control" name="doc" id="doctor" placeholder="Select Doctor">
                            <div id="doctorlist" class="fixed-list col-md-12 d-none">
                                <ul id="dynamic-list" class="list-unstyled"></ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group position-relative">
                            <input type="text" class="form-control" name="special" id="special" placeholder="Select Specialization">
                            <div id="spList" class="fixed-list col-md-12 d-none">
                                <ul id="spDynamicList" class="list-unstyled"></ul>
                            </div>
                        </div>
                    </div>

                        <div class="col-md-4">
                            <input type="date" class="form-control" name="date" id="speciality" placeholder="Enter Speciality">
                        </div>

                        <div class="col-md-12 text-center">
                            <button type="submit" id="makeappointment" class="btn medilife-btn">Make an Appointment <span>+</span></button>
                        </div>
                    </div>
                </form>
            </div>
